...
<div class="" style="margin:40px auto 0px; width:250px">
	<a href="http://lineshjose.com/" target="_blank" style="margin:5px auto; display:block; width: 160px;"><img src="<?php  echo  $wp_lj_plugin['url']; ?>inc/images/lin_logo.png" alt="A LineshJose.com Magic" title="A LineshJose.com Magic" width="150" height="36" class="" style="height:36px; width:150px;"/></a>
