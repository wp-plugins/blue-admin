...
**Note:** From this version, We have changed core settings. If you are using old Blue Admin plugin, please delete current version of Blue Admin from your WordPress plugin directory before installing/updating.  
...
To contact the author the mail is lineshjose(@)gmail(.)com   